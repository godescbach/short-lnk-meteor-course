...
// create boolean state called justCopied = false
// on success switch just
...
export default class LinksListItem extends React.Component {
    ...
    renderStats() {
      ...
      return ( <p className="item__message">{this.props.visited} {visitMessage} {visitedMessage}</p>);
    }
...
LinksListItem.propTypes = {
    ...
    visited: React.PropTypes.number.isRequired,
